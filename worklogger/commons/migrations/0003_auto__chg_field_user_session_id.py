...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.session_id'
        db.alter_column(u'commons_user', 'session_id', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'User.session_id'
        db.alter_column(u'commons_user', 'session_id', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'commons.user': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        }
    }
